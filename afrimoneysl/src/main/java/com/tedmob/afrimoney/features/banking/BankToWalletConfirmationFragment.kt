...
class BankToWalletConfirmationFragment : BaseVBFragment<FragmentBankToWalletConfirmationBinding>() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return createViewBinding(container, FragmentBankToWalletConfirmationBinding::inflate)
    }
    ...
    private fun FragmentBankToWalletConfirmationBinding.observeData() {
    ...
    private fun FragmentBankToWalletConfirmationBinding.setupData(data: GetFeesData) {
        with(data) {
    ...
    private inline fun FragmentBankToWalletConfirmationBinding.setupValidator() = formValidator {
