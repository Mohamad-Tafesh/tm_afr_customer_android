...
import com.tedmob.afrimoney.databinding.FragmentBankToWalletBinding
...
@AndroidEntryPoint
class BankToWalletFragment : BaseVBFragment<FragmentBankToWalletBinding>() {
    ...
    override fun onCreateView(
        ...
        return createViewBinding(container, FragmentBankToWalletBinding::inflate, false)
    }
    ...
    private fun FragmentBankToWalletBinding.setupValidator(): FormValidator = formValidator {
    ...
    private fun proceed() {
        observeResource(viewModel.data){
            findNavController().navigate(
                BankToWalletFragmentDirections.actionBankToWalletFragmentToBankToWalletConfirmationFragment(args.bank)
            )
        }
