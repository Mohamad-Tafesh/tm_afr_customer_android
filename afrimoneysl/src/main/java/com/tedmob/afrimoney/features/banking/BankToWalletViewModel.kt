...
import com.tedmob.afrimoney.features.banking.domain.GetFeesBankUseCase
...
@HiltViewModel
class BankToWalletViewModel
@Inject constructor(

    private val getFeesUseCase: GetFeesBankUseCase,
    private val submit: SubmitBankToWalletDataUseCase,
    ...
    private var fees: String by encrypted(encryptor, "")
    ...
    fun confirm(
        ...
        executeResource(
            submit,
            SubmitBankToWalletDataUseCase.Params(
