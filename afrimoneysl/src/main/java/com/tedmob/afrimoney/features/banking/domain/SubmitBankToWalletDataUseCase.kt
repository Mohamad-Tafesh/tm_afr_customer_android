...
class SubmitBankToWalletDataUseCase
@Inject constructor(

    private val api: TedmobApis,
) : SuspendableUseCase<SubmitResult, SubmitBankToWalletDataUseCase.Params>() {

    override suspend fun execute(params: Params): SubmitResult {


        val response = api.BankToWallet(params.amount,params.bankNumber,params.bankId,params.pin)
