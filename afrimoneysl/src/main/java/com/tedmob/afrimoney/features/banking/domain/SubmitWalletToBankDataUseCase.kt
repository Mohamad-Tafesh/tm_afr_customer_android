...
class SubmitWalletToBankDataUseCase
@Inject constructor(

    private val api: TedmobApis,
) : SuspendableUseCase<SubmitResult, SubmitWalletToBankDataUseCase.Params>() {

    override suspend fun execute(params: Params): SubmitResult {


        val response = api.WalletToBank(params.amount,params.bankNumber,params.bankId,params.pin)
