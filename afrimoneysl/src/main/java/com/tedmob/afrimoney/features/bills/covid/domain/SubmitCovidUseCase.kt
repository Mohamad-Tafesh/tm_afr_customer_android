...
class SubmitCovidUseCase
@Inject constructor(

    private val api: TedmobApis,
) : SuspendableUseCase<SubmitResult, SubmitCovidUseCase.Params>() {

    override suspend fun execute(params: Params): SubmitResult {
      val   response = api.powergen(params.nb, params.amount, params.pin)
       // if (params.type=="cancel") response = api.powergen(params.nb, params.amount, params.pin)
       // else  response = api.powergen(params.nb, params.amount, params.pin)
