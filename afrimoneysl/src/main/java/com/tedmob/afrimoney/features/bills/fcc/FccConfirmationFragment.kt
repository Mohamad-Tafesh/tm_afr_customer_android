...
@AndroidEntryPoint
class FccConfirmationFragment :
    BaseVBFragment<FragmentFccConfirmationBinding>() {
    ...
    override fun onCreateView(
        ...
        return createViewBinding(container, FragmentFccConfirmationBinding::inflate)
    }
    ...
    private fun FragmentFccConfirmationBinding.observeData() {
        withVBAvailable {
    ...
    private fun FragmentFccConfirmationBinding.setupData(data: FccViewModel.FccData) {
        with(data) {
            firstName.text = data.fName
            lastName.text = data.lName
            address.text = data.adress
            feesText.text= getString(R.string.fees_new,data.tax)

        }
    }

    private inline fun FragmentFccConfirmationBinding.setupValidator() = formValidator {
