...
@AndroidEntryPoint
class MercuryConfirmationFragment :
    BaseVBFragment<FragmentMercuryConfirmationBinding>() {
    ...
    override fun onCreateView(
        ...
        return createViewBinding(container, FragmentMercuryConfirmationBinding::inflate)
    }
    ...
    private fun FragmentMercuryConfirmationBinding.observeData() {
        withVBAvailable {
    ...
    private fun FragmentMercuryConfirmationBinding.setupData(data: MercuryViewModel.MercuryData) {
        with(data) {
            tpmNumber.text = data.number
            amountText.text= getString(R.string.amount_currency,data.amount)

        }
    }

    private inline fun FragmentMercuryConfirmationBinding.setupValidator() = formValidator {
