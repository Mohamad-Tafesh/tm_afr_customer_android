package com.tedmob.afrimoney.features.bills.mercury.domain
...
class SubmitMercuryUseCase
@Inject constructor(

    private val api: TedmobApis,
) : SuspendableUseCase<SubmitResult, SubmitMercuryUseCase.Params>() {

    override suspend fun execute(params: Params): SubmitResult {


        val response = api.mercury(params.nb, params.amount, params.pin)
