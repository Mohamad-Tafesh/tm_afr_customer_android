...
@AndroidEntryPoint
class PostPaidConfirmationFragment :
    BaseVBFragment<FragmentPostPaidConfirmationBinding>() {
    ...
    override fun onCreateView(
        ...
        return createViewBinding(container, FragmentPostPaidConfirmationBinding::inflate)
    }
    ...
    private fun FragmentPostPaidConfirmationBinding.observeData() {
        withVBAvailable {
    ...
    private fun FragmentPostPaidConfirmationBinding.setupData(data:PostPaidViewModel.PostPaidData) {
        with(data) {
    ...
    private inline fun FragmentPostPaidConfirmationBinding.setupValidator() = formValidator {
