package com.tedmob.afrimoney.features.bills.postpaid.domain
...
class SubmitPostpaidUseCase
@Inject constructor(

    private val api: TedmobApis,
) : SuspendableUseCase<SubmitResult, SubmitPostpaidUseCase.Params>() {

    override suspend fun execute(params: Params): SubmitResult {


        val response = api.postpaid(params.accNb, params.amount, params.pin)
