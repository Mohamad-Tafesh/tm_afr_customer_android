...
class GetFeesAgentCodeUseCase
@Inject constructor(
    private val api: TedmobApis,
) : SuspendableUseCase<GetFeesData, GetFeesAgentCodeUseCase.Params>(){
    ...
    /*    val receiverName = data?.getObject("receiver")
       ...
       return GetFeesData( params.code ,params.amount,(taxes1).toString(),receiverName.orEmpty(),total.toString())
    }
