...
public class MediaPicker {
    ...
    private MediaPicker(Builder builder) {
        ...
        menuCallback = builder.menuCallback;
    ...
    private boolean prepareFile(String extension) {
        ...
        if (directory == null) {
            ...
            if (!externalState.equals(Environment.MEDIA_MOUNTED)) {
                //switch to using getFilesDir
                directory = new File(activity.getFilesDir(), directoryName);
            }
        }
        if (!directory.exists()) {
            if (!directory.mkdirs()) {
            ...
            case Type.IMAGE_BOTH:
                if (menuCallback != null) {
                    ...
                    String[] imageTypes = {activity.getString(R.string.media_picker__take_photo),
                            ...
                            activity.getString(R.string.media_picker__delete_image)};
            ...
            case Type.VIDEO_BOTH:
                if (menuCallback != null) {
                    ...
                    String[] videoTypes = {activity.getString(R.string.media_picker__take_video),
                            ...
                            activity.getString(R.string.media_picker__delete_video)};
    ...
    public static final class Builder {
        ...
        public Builder(MediaPicker copy) {
            ...
            this.menuCallback = copy.menuCallback;
        ...
        public Builder menuCallback(MenuCallback val) {
            menuCallback = val;
            return this;
        }
