...
class AfrimoneyBundleCategoriesFragment : BaseFragment() {
    ...
    val adapter by lazy {
        AfrimoneyBundleCategoriesAdapter(mutableListOf(), object : AfrimoneyBundleCategoriesAdapter.Callback {
            override fun onItemClickListener(item: BundleCategoriesDTO) {
                ...
                findNavController().navigate(R.id.action_afrimoneyBundleCategoriesFragment_to_afrimoneyBundleVPFragment, bundle)
            }
        })
    }
