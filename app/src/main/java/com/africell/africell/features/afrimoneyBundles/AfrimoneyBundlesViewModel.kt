...
@HiltViewModel
class AfrimoneyBundlesViewModel
@Inject constructor(
    private val getBundlesCategoryUseCase: GetAfrimoneyBundleCategoriesUseCase,
    private val getBundlesByCategoryUseCase: GetAfrimoneyBundlesByCategoryUseCase,
    ...
    fun getBundlesByCategory(categoryId: String, search: String?) {
        ...
        ResourceUseCaseExecutor(
            ...
            GetAfrimoneyBundlesByCategoryUseCase.Params(categoryId, search),
            bundlesData,
            appExceptionFactory,
            appSessionNavigator
        ) {
